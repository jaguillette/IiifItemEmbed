<div aria-live="polite">
  <h3><?php echo link_to_item(__('Mirador 3 viewer'), array('id' => 'mirador-3-embed-link'), 'mirador3', $item); ?></h3>
  <label for="mirador-3-embed-code">Embed Code: </label>
  <input style="display:inline-block;" type="text" name="mirador-3-embed-code" id="mirador-3-embed-code" value='<iframe src="<?php echo absolute_url(array("things" => "item", "id" => $item->id), 'iiifItemEmbed_Mirador3'); ?>" width="100%" height="600px"></iframe>'>
