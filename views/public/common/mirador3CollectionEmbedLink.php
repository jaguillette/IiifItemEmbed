<div aria-live="polite">
  ...
  <input style="display:inline-block;" type="text" name="mirador-3-embed-code" id="mirador-3-embed-code" value='<iframe src="<?php echo absolute_url(array("things" => "collection", "id" => $collection->id), 'iiifItemEmbed_Mirador3'); ?>" width="100%" height="600px"></iframe>'>
